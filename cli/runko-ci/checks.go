...
// ChecksOutput is what `runko-ci checks` prints.
...
// another's.
func Checks(repoDir, base, head string, rootInvalidationPatterns []string) (ChecksOutput, error) {
	...
	return ChecksOutput{RunEverything: out.RunEverything, Checks: runs}, nil
}
